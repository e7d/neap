...
<?php
    ...
    class FixturesGenerator
    {
        ...
        public function generate()
        {
            ...
            $data['userNames'] = array_slice($data['userNames'], 0, 1275); //mt_rand(500, 1500));
