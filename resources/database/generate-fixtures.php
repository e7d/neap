    ...
    class FixturesGenerator
    {
        ...
        public function generate()
        {
            ...
            $data['teamNames'] = array(
                UUID::v4() => 'Lonely Assailant',
                UUID::v4() => 'Incredible Alliance',
                UUID::v4() => 'Tasteful Almighty',
                UUID::v4() => 'Inquisitive Discipline',
                UUID::v4() => 'Peaceful Irresistible',
                UUID::v4() => 'Earsplitting Rebels',
                UUID::v4() => 'Envious Liquidators',
                UUID::v4() => 'Encouraging Knights',
                UUID::v4() => 'Zonked Exile',
                UUID::v4() => 'Hollow Coercion',
                UUID::v4() => 'Troubled Desperado',
                UUID::v4() => 'Dead Assassins',
                UUID::v4() => 'Royal Gangsters',
                UUID::v4() => 'Parsimonious Voltiac',
                UUID::v4() => 'Ajar Enemy',
                UUID::v4() => 'Billowy Warfare',
                UUID::v4() => 'Oval Gang',
                UUID::v4() => 'Acidic Occupation',
                UUID::v4() => 'Hilarious Outlaws',
                UUID::v4() => 'Expensive Moguls',
                UUID::v4() => 'Deafening Veterans',
                UUID::v4() => 'Wealthy Deadly',
                UUID::v4() => 'Hot Force',
                UUID::v4() => 'Deserted Butchers',
                UUID::v4() => 'Nondescript Sharpshooters',
                UUID::v4() => 'Abundant Privilege',
                UUID::v4() => 'Magical Thugs',
                UUID::v4() => 'Able Power',
                UUID::v4() => 'Honorable Criminals',
                UUID::v4() => 'Inexpensive Vigor',
                UUID::v4() => 'Rich Domination',
                UUID::v4() => 'Useful Slayers',
                UUID::v4() => 'Orange Devils',
                UUID::v4() => 'Undesirable Tyranny',
                UUID::v4() => 'Polite Hooligans',
                UUID::v4() => 'Protective Punks',
                UUID::v4() => 'Aquatic Strategy',
                UUID::v4() => 'Future Squad',
                UUID::v4() => 'Overwrought Exterminators',
                UUID::v4() => 'Whimsical Prestige',
                UUID::v4() => 'Dashing Admirals',
                UUID::v4() => 'Periodic Perpetrator',
                UUID::v4() => 'Maniacal Mafia',
                UUID::v4() => 'Gruesome Soldiers',
                UUID::v4() => 'Capable killers',
                UUID::v4() => 'Sweltering Noobs',
                UUID::v4() => 'Square Superpower',
                UUID::v4() => 'Alluring Bureau',
                UUID::v4() => 'Materialistic Delinquents',
                UUID::v4() => 'Tacky Privilege',
                UUID::v4() => 'Diligent Thugs',
                UUID::v4() => 'Spiffy Power',
                UUID::v4() => 'Lackadaisical Criminals',
                UUID::v4() => 'Snotty Vigor',
                UUID::v4() => 'Melodic Domination',
                UUID::v4() => 'Tiny Slayers',
                UUID::v4() => 'Messy Devils',
                UUID::v4() => 'Different Tyranny',
                UUID::v4() => 'Foregoing Hooligans',
                UUID::v4() => 'Spiritual Punks'
            );
            ...
            for ($outageIndex = 0; $outageIndex < 10; $outageIndex++) {
                ...
                $outageEndedAt = DateConverter::fromTimestamp($outageStartedAtTimestamp + mt_rand(1, 2 * 3600));
            ...
            foreach ($data['teamNames'] as $teamId => $teamDisplayName) {
                ...
                $teamCreatedAtTimestamp = DateConverter::randomTimestamp(1420070400);
                $teamCreatedAt = DateConverter::fromTimestamp($teamCreatedAtTimestamp);
                $teamUpdatedAt = DateConverter::fromTimestamp(DateConverter::randomTimestamp($teamCreatedAtTimestamp));
            ...
            foreach ($data['userNames'] as $userDisplayName) {
                ...
                if ($userTeamCount > 0) {
                    ...
                    foreach ($memberTeamIdList as $memberTeamId) {
                        // Prepare user specific data
                        $memberCreatedAt = DateConverter::fromTimestamp($userCreatedAtTimestamp);
                ...
                for ($streamIndex = 0; $streamIndex < mt_rand(0, 20); $streamIndex++) {
                    ...
                    for ($videoIndex = 0; $videoIndex < mt_rand(0, 2); $videoIndex++) {
                        ...
                        for ($favoriteIndex = 0; $favoriteIndex < mt_rand(0, round($videoViews / 100)); $favoriteIndex++) {
                            ...
                            $favoriteCreatedAtTimestamp = DateConverter::randomTimestamp(1420070400);
                            $favoriteCreatedAt = DateConverter::fromTimestamp($favoriteCreatedAtTimestamp);
